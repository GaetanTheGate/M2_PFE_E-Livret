...
public class TestEQuestionController {
        ...
        public void getFromIdTest() {
                ...
                ResponseEntity<EQuestionDTO.Out.AllPublic> r_student = rest.exchange(BASE_URL + PATH_URL,
                                HttpMethod.GET,
                ...
                ResponseEntity<EQuestionDTO.Out.AllPublic> r_responsable = rest.exchange(BASE_URL + PATH_URL,
                                HttpMethod.GET,
                                new HttpEntity<>(headers), EQuestionDTO.Out.AllPublic.class);

                headers.set("Authorization", "Bearer " + token_someone);
                ResponseEntity<EQuestionDTO.Out.AllPublic> r_someone = rest.exchange(BASE_URL + PATH_URL,
                                HttpMethod.GET,
                                new HttpEntity<>(headers), EQuestionDTO.Out.AllPublic.class);
        ...
        public void deleteQuestionFromId() {
                // Given
                EQuestion q = buildQuestionBase("deleteQuestionFromId", UserRole.STUDENT, true, QuestionType.TEXT)
                                .build();
                ...
                // When
                headers.set("Authorization", "Bearer " + token_responsable);
                ResponseEntity<EQuestionDTO.Out.AllPublic> r_responsable_get1 = rest.exchange(BASE_URL + PATH_URL,
                                HttpMethod.GET,
                                new HttpEntity<>(headers), EQuestionDTO.Out.AllPublic.class);
                ...
                ResponseEntity<EQuestionDTO.Out.AllPublic> r_responsable_get2 = rest.exchange(BASE_URL + PATH_URL,
                                HttpMethod.GET,
                                new HttpEntity<>(headers), EQuestionDTO.Out.AllPublic.class);
