...
public class EntityAccessAuthorization {
    ...
    public boolean isMeFromLivret(HttpServletRequest req, EQuestion question)
            throws AuthentificationException, EUserException, ELivretException, ESectionException, EQuestionException {
     ...
     * @throws EAnswerException
     */
    public boolean isAnswerMine(HttpServletRequest req, Integer id) throws AuthentificationException, EUserException,
