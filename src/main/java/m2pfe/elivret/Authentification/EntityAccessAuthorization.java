...
public class EntityAccessAuthorization {
     ...
     */
    public boolean isMeFromLivret(HttpServletRequest req, ESection section) throws AuthentificationException, EUserException, ELivretException, ESectionException {
     ...
     */
    public boolean isMeFromLivret(HttpServletRequest req, EAnswer answer) throws AuthentificationException, EUserException, ELivretException, ESectionException, EQuestionException, EAnswerException {
     ...
     * @throws ESectionException
     */
    public boolean isLivretMine(HttpServletRequest req, ESection section) throws AuthentificationException, EUserException, ELivretException, ESectionException {
     ...
     * @throws EAnswerException
     */
    public boolean isLivretMine(HttpServletRequest req, EAnswer answer) throws AuthentificationException, EUserException, ELivretException, ESectionException, EQuestionException, EAnswerException {
