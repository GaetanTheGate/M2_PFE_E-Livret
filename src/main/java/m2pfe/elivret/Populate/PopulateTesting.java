...
public class PopulateTesting {
        ...
        switch (type) {
            ...
            case RADIO:
                question = multipleQuestion(List.of("Valeur 1", "Valeur 2", "Valeur 3"),
                        List.of("Reponse 1 : " + title, "Reponse 2 : " + title, "Reponse 3 : " + title));
                break;
            default:
                question = labelQuestion();
                break;
    ...
    private void createExampleLivret() {
        ...
        ESection s_ident_student = sr
                .save(new ESection(0, UserRole.STUDENT, true, "Fiche d'identité de l'apprenti(e)", livret, null));
        ESection s_ident_company = sr
                .save(new ESection(0, UserRole.MASTER, true, "Informations sur l'entreprise d'accueil", livret, null));
        ESection s_ident_master = sr.save(
                new ESection(0, UserRole.MASTER, true, "Fiche d'identité du maitre d'apprentissage", livret, null));
        ESection s_ident_fomatation = sr.save(
                new ESection(0, UserRole.TUTOR, true, "Informations sur la formation de l'apprenti(e)", livret, null));
        ESection s_ident_tutor = sr
                .save(new ESection(0, UserRole.TUTOR, true, "Fiche d'identité de tuteur pédagogique", livret, null));

        ESection s_present_forma = sr
                .save(new ESection(0, UserRole.TUTOR, true, "Présentation de la formation", livret, null));
        ...
        ESection s_suivi_1_sem = sr
                .save(new ESection(0, UserRole.MASTER, true, "Fiche de suivi du 1er semestre", livret, null));
        ...
        ESection s_comment_stud_1 = sr.save(
                new ESection(0, UserRole.STUDENT, true, "Commentaire de l'apprenti(e) du 1er semestre", livret, null));
        ...
        ESection s_suivi_2_sem = sr
                .save(new ESection(0, UserRole.MASTER, true, "Fiche de suivi du 2ème semestre", livret, null));
        ...
        ESection s_comment_stud_2 = sr.save(
                new ESection(0, UserRole.STUDENT, true, "Commentaire de l'apprenti(e) du 2ème semestre", livret, null));
        ...
        ESection s_eval_student = sr.save(
                new ESection(0, UserRole.STUDENT, true, "Evaluation de la formation par les apprentis", livret, null));
        ESection s_eval_company = sr.save(
                new ESection(0, UserRole.MASTER, true, "Evaluation de la formation par l'entreprise", livret, null));

        EQuestion q_ident_student_1 = qr
                .save(EQuestion.builder().section(s_ident_student).type(QuestionType.RADIO).title("Civilité").build());
        ...
        EQuestion q_ident_student_2 = qr
                .save(EQuestion.builder().section(s_ident_student).type(QuestionType.TEXT).title("Nom").build());
        ar.save(EAnswer.builder().question(q_ident_student_2).build());
        EQuestion q_ident_student_3 = qr
                .save(EQuestion.builder().section(s_ident_student).type(QuestionType.TEXT).title("Prénom").build());
        ar.save(EAnswer.builder().question(q_ident_student_3).build());
        EQuestion q_ident_student_4 = qr.save(EQuestion.builder().section(s_ident_student).type(QuestionType.TEXT)
                .title("Date de naissance").build());
        ar.save(EAnswer.builder().question(q_ident_student_4).build());
        EQuestion q_ident_student_5 = qr
                .save(EQuestion.builder().section(s_ident_student).type(QuestionType.TEXT).title("Adresse").build());
        ar.save(EAnswer.builder().question(q_ident_student_5).build());
        EQuestion q_ident_student_6 = qr
                .save(EQuestion.builder().section(s_ident_student).type(QuestionType.TEXT).title("Téléphone").build());
        ar.save(EAnswer.builder().question(q_ident_student_6).build());
        EQuestion q_ident_student_7 = qr
                .save(EQuestion.builder().section(s_ident_student).type(QuestionType.TEXT).title("Mail").build());
        ar.save(EAnswer.builder().question(q_ident_student_7).build());
        EQuestion q_ident_student_8 = qr.save(
                EQuestion.builder().section(s_ident_student).type(QuestionType.TEXT).title("Dates de contrat").build());
        ar.save(EAnswer.builder().question(q_ident_student_8).build());

        EQuestion q_ident_company_1 = qr
                .save(EQuestion.builder().section(s_ident_company).type(QuestionType.TEXT).title("Nom").build());
        ar.save(EAnswer.builder().question(q_ident_company_1).build());
        EQuestion q_ident_company_2 = qr
                .save(EQuestion.builder().section(s_ident_company).type(QuestionType.TEXT).title("Adresse").build());
        ar.save(EAnswer.builder().question(q_ident_company_2).build());

        EQuestion q_ident_master_1 = qr
                .save(EQuestion.builder().section(s_ident_master).type(QuestionType.TEXT).title("Nom").build());
        ar.save(EAnswer.builder().question(q_ident_master_1).build());
        EQuestion q_ident_master_2 = qr
                .save(EQuestion.builder().section(s_ident_master).type(QuestionType.TEXT).title("Prénom").build());
        ar.save(EAnswer.builder().question(q_ident_master_2).build());
        EQuestion q_ident_master_3 = qr
                .save(EQuestion.builder().section(s_ident_master).type(QuestionType.TEXT).title("Fonction").build());
        ar.save(EAnswer.builder().question(q_ident_master_3).build());
        EQuestion q_ident_master_4 = qr
                .save(EQuestion.builder().section(s_ident_master).type(QuestionType.TEXT).title("Téléphone").build());
        ar.save(EAnswer.builder().question(q_ident_master_4).build());
        EQuestion q_ident_master_5 = qr
                .save(EQuestion.builder().section(s_ident_master).type(QuestionType.TEXT).title("Mail").build());
        ar.save(EAnswer.builder().question(q_ident_master_5).build());

        EQuestion q_ident_fomatation_1 = qr
                .save(EQuestion.builder().section(s_ident_fomatation).type(QuestionType.TEXT).title("Mail").build());
        ar.save(EAnswer.builder().question(q_ident_fomatation_1).build());
        EQuestion q_ident_fomatation_2 = qr
                .save(EQuestion.builder().section(s_ident_fomatation).type(QuestionType.TEXT).title("Adresse").build());
        ar.save(EAnswer.builder().question(q_ident_fomatation_2).build());

        EQuestion q_ident_tutor_1 = qr
                .save(EQuestion.builder().section(s_ident_tutor).type(QuestionType.TEXT).title("Nom").build());
        ar.save(EAnswer.builder().question(q_ident_tutor_1).build());
        EQuestion q_ident_tutor_2 = qr
                .save(EQuestion.builder().section(s_ident_tutor).type(QuestionType.TEXT).title("Prénom").build());
        ar.save(EAnswer.builder().question(q_ident_tutor_2).build());
        EQuestion q_ident_tutor_3 = qr
                .save(EQuestion.builder().section(s_ident_tutor).type(QuestionType.TEXT).title("Fonction").build());
        ar.save(EAnswer.builder().question(q_ident_tutor_3).build());
        EQuestion q_ident_tutor_4 = qr
                .save(EQuestion.builder().section(s_ident_tutor).type(QuestionType.TEXT).title("Téléphone").build());
        ar.save(EAnswer.builder().question(q_ident_tutor_4).build());
        EQuestion q_ident_tutor_5 = qr
                .save(EQuestion.builder().section(s_ident_tutor).type(QuestionType.TEXT).title("Mail").build());
        ar.save(EAnswer.builder().question(q_ident_tutor_5).build());

        EQuestion q_present_forma_1 = qr.save(EQuestion.builder().section(s_present_forma).type(QuestionType.LABEL)
                .title("Le document complet de présentation de la formation est disponible à cette adresse").build());
        EQuestion q_present_forma_2 = qr.save(EQuestion.builder().section(s_present_forma).type(QuestionType.LABEL)
        ...
        EQuestion q_calendar_1 = qr.save(EQuestion.builder().section(s_calendar).type(QuestionType.LABEL)
                .title("Le calendrier d’alternance de la formation est disponible à cette adresse").build());
        ...
        EQuestion s_suivi_1_sem_1 = qr.save(EQuestion.builder().section(s_suivi_1_sem).type(QuestionType.LABEL).title(
        ...
        EQuestion s_suivi_1_sem_3 = qr.save(EQuestion.builder().section(s_suivi_1_sem).type(QuestionType.RADIO)
                .title("Efficacité au travail (ponctuel, opérationnel, actif, sens du travail bien fait...)").build());
        ...
        EQuestion s_suivi_1_sem_4 = qr.save(EQuestion.builder().section(s_suivi_1_sem).type(QuestionType.RADIO).title(
        ...
        EQuestion s_suivi_1_sem_6 = qr.save(EQuestion.builder().section(s_suivi_1_sem).type(QuestionType.RADIO)
                .title("Coopération (volonté d'apprendre, polyvalence, interroge ses formateurs)").build());
        ...
        EQuestion s_suivi_1_sem_7 = qr.save(EQuestion.builder().section(s_suivi_1_sem).type(QuestionType.RADIO).title(
        ...
        EQuestion s_suivi_1_sem_8 = qr.save(EQuestion.builder().section(s_suivi_1_sem).type(QuestionType.RADIO).title(
        ...
        EQuestion q_observ_master_1_1 = qr.save(
                EQuestion.builder().section(s_observ_master_1).type(QuestionType.TEXT).title("Points forts").build());
        ar.save(EAnswer.builder().question(q_observ_master_1_1).build());
        EQuestion q_observ_master_1_2 = qr.save(EQuestion.builder().section(s_observ_master_1).type(QuestionType.TEXT)
        ...
        EQuestion q_comment_master_1_1 = qr.save(EQuestion.builder().section(s_comment_master_1)
                ...
                .build());
        EQuestion q_comment_master_1_2 = qr.save(EQuestion.builder().section(s_comment_master_1).type(QuestionType.TEXT)
                .title("Ecrire un commentaire").build());
        ar.save(EAnswer.builder().question(q_comment_master_1_2).build());

        EQuestion q_comment_stud_1_1 = qr.save(EQuestion.builder().section(s_comment_stud_1).type(QuestionType.LABEL)
                .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions, ses difficultés, en ce qui concerne :\n"
                        + "• la définition des objectifs,\n" + "• les moyens mis en œuvre,\n"
                        + "• l’adéquation entre le sujet proposé et l’apprentissage réel,\n"
                        + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.")
                .build());
        EQuestion q_comment_stud_1_2 = qr.save(EQuestion.builder().section(s_comment_stud_1).type(QuestionType.TEXT)
                .title("Ecrire un commentaire").build());
        ar.save(EAnswer.builder().question(q_comment_stud_1_2).build());

        EQuestion q_comment_tutor_1_1 = qr.save(EQuestion.builder().section(s_comment_tutor_1).type(QuestionType.LABEL)
                .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions, ses difficultés, en ce qui concerne :\n"
                        + "• la définition des objectifs,\n" + "• les moyens mis en œuvre,\n"
                        + "• l’adéquation entre le sujet proposé et l’apprentissage réel,\n"
                        + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.")
                .build());
        EQuestion q_comment_tutor_1_2 = qr.save(EQuestion.builder().section(s_comment_tutor_1).type(QuestionType.TEXT)
                .title("Ecrire un commentaire").build());
        ar.save(EAnswer.builder().question(q_comment_tutor_1_2).build());

        // TODO : rajouter les observations aux choix radio, comme dans le tableau
        EQuestion s_suivi_2_sem_1 = qr.save(EQuestion.builder().section(s_suivi_2_sem).type(QuestionType.LABEL).title(
                "Le présent document de suivi est à remplir par le Maître d’apprentissage en présence de l’apprenti. NB : ce document compte pour l'obtention du diplôme.")
                .build());
        ...
        EQuestion s_suivi_2_sem_4 = qr.save(EQuestion.builder().section(s_suivi_2_sem).type(QuestionType.RADIO).title(
                "Compréhension et assimilation (niveau de connaissances, rapidité à intégrer des éléments nouveaux...)")
                .build());
        ...
        EQuestion s_suivi_2_sem_7 = qr.save(EQuestion.builder().section(s_suivi_2_sem).type(QuestionType.RADIO).title(
                "Relations avec le personnel, esprit d'équipe (aptitude à communiquer, oral et écrit, sens du contact, intégration dans l'équipe)")
                .build());
        ...
        EQuestion s_suivi_2_sem_8 = qr.save(EQuestion.builder().section(s_suivi_2_sem).type(QuestionType.RADIO).title(
                "Disponibilité (esprit d'équipe, prêt à rendre service sollicite travail et responsabilités, adaptabilité)")
                .build());
        ...
        EQuestion q_observ_master_2_1 = qr.save(
                EQuestion.builder().section(s_observ_master_2).type(QuestionType.TEXT).title("Points forts").build());
        ar.save(EAnswer.builder().question(q_observ_master_2_1).build());
        EQuestion q_observ_master_2_2 = qr.save(EQuestion.builder().section(s_observ_master_2).type(QuestionType.TEXT)
                .title("Points à améliorer").build());
        ...
        EQuestion q_comment_master_2_1 = qr.save(EQuestion.builder().section(s_comment_master_2)
                ...
                .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions,\n"
                        ...
                        + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.")
                .build());
        EQuestion q_comment_master_2_2 = qr.save(EQuestion.builder().section(s_comment_master_2).type(QuestionType.TEXT)
                .title("Ecrire un commentaire").build());
        ar.save(EAnswer.builder().question(q_comment_master_2_2).build());

        EQuestion q_comment_stud_2_1 = qr.save(EQuestion.builder().section(s_comment_stud_2).type(QuestionType.LABEL)
                .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions,\n"
                        + "ses difficultés, en ce qui concerne :\n" + "• la définition des objectifs,\n"
                        + "• les moyens mis en œuvre,\n"
                        + "• l’adéquation entre le sujet proposé et l’apprentissage réel,\n"
                        + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.")
                .build());
        EQuestion q_comment_stud_2_2 = qr.save(EQuestion.builder().section(s_comment_stud_2).type(QuestionType.TEXT)
                .title("Ecrire un commentaire").build());
        ar.save(EAnswer.builder().question(q_comment_stud_2_2).build());

        EQuestion q_comment_tutor_2_1 = qr.save(EQuestion.builder().section(s_comment_tutor_2).type(QuestionType.LABEL)
                .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions,\n"
                        + "ses difficultés, en ce qui concerne :\n" + "• la définition des objectifs,\n"
                        + "• les moyens mis en œuvre,\n"
                        + "• l’adéquation entre le sujet proposé et l’apprentissage réel,\n"
                        + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.")
                .build());
        EQuestion q_comment_tutor_2_2 = qr.save(EQuestion.builder().section(s_comment_tutor_2).type(QuestionType.TEXT)
                .title("Ecrire un commentaire").build());
        ar.save(EAnswer.builder().question(q_comment_tutor_2_2).build());

        EQuestion q_eval_student_1 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.LABEL)
                .title("1) Évaluation des enseignements par les apprentis").build());
        EQuestion q_eval_student_2 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.LABEL).title(
                ...
                .build());
        EQuestion q_eval_student_3 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.LABEL)
                .title("2) Enquête de satisfaction des apprentis (enquête FORMASUP PACA/CFA Épure Méditerranée)")
                .build());
        EQuestion q_eval_student_4 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.LABEL).title(
                ...
                .build());
        EQuestion q_eval_student_5 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.LABEL).title(
                ...
                .build());
        EQuestion q_eval_student_6 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.LABEL)
                .title("3) Questionnaire de fin d’année à l’attention des apprentis (modèle !)").build());
        EQuestion q_eval_student_7 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.RADIO)
                .title("Les connaissances acquises vous semblent-elles utilisables en pratique ?").build());
        ...
        EQuestion q_eval_student_8 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.RADIO)
        ...
        EQuestion q_eval_student_9 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.RADIO).title(
        ...
        EQuestion q_eval_student_10 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.RADIO)
                .title("Êtes-vous satisfait des locaux et équipements mis à disposition par l'Université ?").build());
        ...
        EQuestion q_eval_student_11 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.RADIO)
        ...
        EQuestion q_eval_student_12 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.RADIO)
                .title("Avez-vous rencontré des difficultés autres durant l'année universitaire ?").build());
        ...
        EQuestion q_eval_student_13 = qr.save(EQuestion.builder().section(s_eval_student).type(QuestionType.TEXT)
                .title("Commentaire général").build());
        ar.save(EAnswer.builder().question(q_eval_student_13).build());

        EQuestion q_eval_company_1 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.LABEL)
        ...
        EQuestion q_eval_company_2 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.RADIO)
        ...
        EQuestion q_eval_company_3 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.RADIO)
        ...
        EQuestion q_eval_company_4 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.LABEL)
                .title("Relation avec la Formation").build());
        EQuestion q_eval_company_5 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.RADIO)
        ...
        EQuestion q_eval_company_6 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.RADIO)
        ...
        EQuestion q_eval_company_7 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.RADIO)
        ...
        EQuestion q_eval_company_8 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.LABEL)
                .title("Suivi de l’apprenti").build());
        EQuestion q_eval_company_9 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.RADIO)
        ...
        EQuestion q_eval_company_10 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.RADIO)
        ...
        EQuestion q_eval_company_11 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.LABEL)
                .title("Évaluation globale").build());
        EQuestion q_eval_company_12 = qr.save(EQuestion.builder().section(s_eval_company).type(QuestionType.RADIO)
        ...
        EQuestion q_eval_company_13 = qr.save(
                EQuestion.builder().section(s_eval_company).type(QuestionType.TEXT).title("Commentaires").build());
