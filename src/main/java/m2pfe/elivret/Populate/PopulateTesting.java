...
public class PopulateTesting {
    ...
    private void createExampleLivret() {
        ...
        ESection s_observ_master_1  = sr.save(new ESection(0, UserRole.MASTER , true, "Observations du maître d’apprentissage du 2ème semestre" , livret, null));
        ...
        ESection s_observ_master_2  = sr.save(new ESection(0, UserRole.MASTER , true, "Observations du maître d’apprentissage du 2ème semestre" , livret, null));
        ...
        EQuestion q_present_forma_1     = qr.save(EQuestion.builder().section(s_present_forma)      .type(QuestionType.LABEL) .title("Le document complet de présentation de la formation est disponible à cette adresse").build());
        EQuestion q_present_forma_2     = qr.save(EQuestion.builder().section(s_present_forma)      .type(QuestionType.LABEL) .title("https://jean-luc-massat.pedaweb.univ-amu.fr/ens/alternance-en-m2idl/").build());

        EQuestion q_calendar_1          = qr.save(EQuestion.builder().section(s_calendar)           .type(QuestionType.LABEL) .title("Le calendrier d’alternance de la formation est disponible à cette adresse").build());
        EQuestion q_calendar_2          = qr.save(EQuestion.builder().section(s_calendar)           .type(QuestionType.LABEL) .title("https://jean-luc-massat.pedaweb.univ-amu.fr/ens/alternance-en-m2idl/").build());
        
        // TODO : rajouter les observations aux choix radio, comme dans le tableau
        EQuestion s_suivi_1_sem_1       = qr.save(EQuestion.builder().section(s_suivi_1_sem)        .type(QuestionType.LABEL) .title("Le présent document de suivi est à remplir par le Maître d’apprentissage en présence de l’apprenti. NB : ce document compte pour l'obtention du diplôme.").build());
        EQuestion s_suivi_1_sem_2       = qr.save(EQuestion.builder().section(s_suivi_1_sem)        .type(QuestionType.LABEL) .title("Critères d'application.").build());
        EQuestion s_suivi_1_sem_3       = qr.save(EQuestion.builder().section(s_suivi_1_sem)        .type(QuestionType.RADIO) .title("Efficacité au travail (ponctuel, opérationnel, actif, sens du travail bien fait...)").build());
        ...
        EQuestion s_suivi_1_sem_4       = qr.save(EQuestion.builder().section(s_suivi_1_sem)        .type(QuestionType.RADIO) .title("Compréhension et assimilation (niveau de connaissances, rapidité à intégrer des éléments nouveaux...)").build());
        ...
        EQuestion s_suivi_1_sem_5       = qr.save(EQuestion.builder().section(s_suivi_1_sem)        .type(QuestionType.RADIO) .title("Curiosité d'esprit (dynamisme, initiative, anticipation...)").build());
        ...
        EQuestion s_suivi_1_sem_6       = qr.save(EQuestion.builder().section(s_suivi_1_sem)        .type(QuestionType.RADIO) .title("Coopération (volonté d'apprendre, polyvalence, interroge ses formateurs)").build());
        ...
        EQuestion s_suivi_1_sem_7       = qr.save(EQuestion.builder().section(s_suivi_1_sem)        .type(QuestionType.RADIO) .title("Relations avec le personnel, esprit d'équipe (aptitude à communiquer, oral et écrit, sens du contact, intégration dans l'équipe)").build());
        ...
        EQuestion s_suivi_1_sem_8       = qr.save(EQuestion.builder().section(s_suivi_1_sem)        .type(QuestionType.RADIO) .title("Disponibilité (esprit d'équipe, prêt à rendre service sollicite travail et responsabilités, adaptabilité)").build());
        ...
        EQuestion s_suivi_1_sem_9       = qr.save(EQuestion.builder().section(s_suivi_1_sem)        .type(QuestionType.RADIO) .title("APPRÉCIATION GÉNÉRALE").build());
        ...
        EQuestion q_observ_master_1_1   = qr.save(EQuestion.builder().section(s_observ_master_1)    .type(QuestionType.TEXT)  .title("Points forts").build());
            ar.save(EAnswer.builder()       .question(q_observ_master_1_1).build());
        EQuestion q_observ_master_1_2   = qr.save(EQuestion.builder().section(s_observ_master_1)    .type(QuestionType.TEXT)  .title("Points à améliorer").build());
            ar.save(EAnswer.builder()       .question(q_observ_master_1_2).build());

        // TODO : Pour les commentaires, les signatures
        EQuestion q_comment_master_1_1  = qr.save(EQuestion.builder().section(s_comment_master_1)   .type(QuestionType.LABEL) .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions, ses difficultés, en ce qui concerne :\n" + "• la définition des objectifs,\n" + "• les moyens mis en œuvre,\n" + "• l’adéquation entre le sujet proposé et l’apprentissage réel,\n" + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.").build());
        EQuestion q_comment_master_1_2  = qr.save(EQuestion.builder().section(s_comment_master_1)   .type(QuestionType.TEXT)  .title("Ecrire un commentaire").build());
            ar.save(EAnswer.builder()       .question(q_comment_master_1_2).build());
    
        EQuestion q_comment_stud_1_1  = qr.save(EQuestion.builder().section(s_comment_stud_1)   .type(QuestionType.LABEL) .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions, ses difficultés, en ce qui concerne :\n" + "• la définition des objectifs,\n" + "• les moyens mis en œuvre,\n" + "• l’adéquation entre le sujet proposé et l’apprentissage réel,\n" + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.").build());
        EQuestion q_comment_stud_1_2  = qr.save(EQuestion.builder().section(s_comment_stud_1)   .type(QuestionType.TEXT)  .title("Ecrire un commentaire").build());
            ar.save(EAnswer.builder()       .question(q_comment_stud_1_2).build());
    
        EQuestion q_comment_tutor_1_1  = qr.save(EQuestion.builder().section(s_comment_tutor_1)   .type(QuestionType.LABEL) .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions, ses difficultés, en ce qui concerne :\n" + "• la définition des objectifs,\n" + "• les moyens mis en œuvre,\n" + "• l’adéquation entre le sujet proposé et l’apprentissage réel,\n" + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.").build());
        EQuestion q_comment_tutor_1_2  = qr.save(EQuestion.builder().section(s_comment_tutor_1)   .type(QuestionType.TEXT)  .title("Ecrire un commentaire").build());
            ar.save(EAnswer.builder()       .question(q_comment_tutor_1_2).build());
    
        // TODO : rajouter les observations aux choix radio, comme dans le tableau
        EQuestion s_suivi_2_sem_1       = qr.save(EQuestion.builder().section(s_suivi_2_sem)        .type(QuestionType.LABEL) .title("Le présent document de suivi est à remplir par le Maître d’apprentissage en présence de l’apprenti. NB : ce document compte pour l'obtention du diplôme.").build());
        EQuestion s_suivi_2_sem_2       = qr.save(EQuestion.builder().section(s_suivi_2_sem)        .type(QuestionType.LABEL) .title("Critères d'application.").build());
        EQuestion s_suivi_2_sem_3       = qr.save(EQuestion.builder().section(s_suivi_2_sem)        .type(QuestionType.RADIO) .title("Efficacité au travail (ponctuel, opérationnel, actif, sens du travail bien fait...)").build());
        ...
        EQuestion s_suivi_2_sem_4       = qr.save(EQuestion.builder().section(s_suivi_2_sem)        .type(QuestionType.RADIO) .title("Compréhension et assimilation (niveau de connaissances, rapidité à intégrer des éléments nouveaux...)").build());
        ...
        EQuestion s_suivi_2_sem_5       = qr.save(EQuestion.builder().section(s_suivi_2_sem)        .type(QuestionType.RADIO) .title("Curiosité d'esprit (dynamisme, initiative, anticipation...)").build());
        ...
        EQuestion s_suivi_2_sem_6       = qr.save(EQuestion.builder().section(s_suivi_2_sem)        .type(QuestionType.RADIO) .title("Coopération (volonté d'apprendre, polyvalence, interroge ses formateurs)").build());
        ...
        EQuestion s_suivi_2_sem_7       = qr.save(EQuestion.builder().section(s_suivi_2_sem)        .type(QuestionType.RADIO) .title("Relations avec le personnel, esprit d'équipe (aptitude à communiquer, oral et écrit, sens du contact, intégration dans l'équipe)").build());
        ...
        EQuestion s_suivi_2_sem_8       = qr.save(EQuestion.builder().section(s_suivi_2_sem)        .type(QuestionType.RADIO) .title("Disponibilité (esprit d'équipe, prêt à rendre service sollicite travail et responsabilités, adaptabilité)").build());
        ...
        EQuestion s_suivi_2_sem_9       = qr.save(EQuestion.builder().section(s_suivi_2_sem)        .type(QuestionType.RADIO) .title("APPRÉCIATION GÉNÉRALE").build());
        ...
        EQuestion q_observ_master_2_1   = qr.save(EQuestion.builder().section(s_observ_master_2)    .type(QuestionType.TEXT)  .title("Points forts").build());
            ar.save(EAnswer.builder()       .question(q_observ_master_2_1).build());
        EQuestion q_observ_master_2_2   = qr.save(EQuestion.builder().section(s_observ_master_2)    .type(QuestionType.TEXT)  .title("Points à améliorer").build());
            ar.save(EAnswer.builder()       .question(q_observ_master_2_2).build());

        // TODO : Pour les commentaires, les signatures
        EQuestion q_comment_master_2_1  = qr.save(EQuestion.builder().section(s_comment_master_2)   .type(QuestionType.LABEL) .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions,\n" + "ses difficultés, en ce qui concerne :\n" + "• la définition des objectifs,\n" + "• les moyens mis en œuvre,\n" + "• l’adéquation entre le sujet proposé et l’apprentissage réel,\n" + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.").build());
        EQuestion q_comment_master_2_2  = qr.save(EQuestion.builder().section(s_comment_master_2)   .type(QuestionType.TEXT)  .title("Ecrire un commentaire").build());
            ar.save(EAnswer.builder()       .question(q_comment_master_2_2).build());
    
        EQuestion q_comment_stud_2_1    = qr.save(EQuestion.builder().section(s_comment_stud_2)     .type(QuestionType.LABEL) .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions,\n" + "ses difficultés, en ce qui concerne :\n" + "• la définition des objectifs,\n" + "• les moyens mis en œuvre,\n" + "• l’adéquation entre le sujet proposé et l’apprentissage réel,\n" + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.").build());
        EQuestion q_comment_stud_2_2    = qr.save(EQuestion.builder().section(s_comment_stud_2)     .type(QuestionType.TEXT)  .title("Ecrire un commentaire").build());
            ar.save(EAnswer.builder()       .question(q_comment_stud_2_2).build());
    
        EQuestion q_comment_tutor_2_1   = qr.save(EQuestion.builder().section(s_comment_tutor_2)    .type(QuestionType.LABEL) .title("A la fin de chaque période en entreprise, l’apprenti-e doit formuler ci-après, ses remarques, ses questions,\n" + "ses difficultés, en ce qui concerne :\n" + "• la définition des objectifs,\n" + "• les moyens mis en œuvre,\n" + "• l’adéquation entre le sujet proposé et l’apprentissage réel,\n" + "• les connaissances requises ou acquises,\n" + "• le vécu relationnel.").build());
        EQuestion q_comment_tutor_2_2   = qr.save(EQuestion.builder().section(s_comment_tutor_2)    .type(QuestionType.TEXT)  .title("Ecrire un commentaire").build());
            ar.save(EAnswer.builder()       .question(q_comment_tutor_2_2).build());
    
        EQuestion q_eval_student_1      = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.LABEL) .title("1) Évaluation des enseignements par les apprentis").build());
        EQuestion q_eval_student_2      = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.LABEL) .title("Le responsable de la formation doit mettre en œuvre un questionnaire permettant aux apprentis d’évaluer les enseignements (il existe des modèles disponibles à FORMASUP PACA/CFA Épure Méditerranée).").build());
        EQuestion q_eval_student_3      = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.LABEL) .title("2) Enquête de satisfaction des apprentis (enquête FORMASUP PACA/CFA Épure Méditerranée)").build());
        EQuestion q_eval_student_4      = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.LABEL) .title("Entre mars et juillet, les apprentis doivent se connecter sur la plateforme collaborative du CFA pour répondre aux enquêtes à l’adresse URL : https://espace.cfa-epure.com/").build());
        EQuestion q_eval_student_5      = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.LABEL) .title("Chaque responsable de formation à accès au questionnaire de FORMASUP PACA/CFA Épure Méditerranée en se connectant sur la plateforme collaborative.").build());
        EQuestion q_eval_student_6      = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.LABEL) .title("3) Questionnaire de fin d’année à l’attention des apprentis (modèle !)").build());
        EQuestion q_eval_student_7      = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.RADIO) .title("Les connaissances acquises vous semblent-elles utilisables en pratique ?").build());
        ...
        EQuestion q_eval_student_8      = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.RADIO) .title("Le rythme d'alternance vous paraît-il satisfaisant ?").build());
        ...
        EQuestion q_eval_student_9      = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.RADIO) .title("Êtes-vous satisfait du secrétariat de la formation en alternance et de la communication des informations ?").build());
        ...
        EQuestion q_eval_student_10     = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.RADIO) .title("Êtes-vous satisfait des locaux et équipements mis à disposition par l'Université ?").build());
        ...
        EQuestion q_eval_student_11     = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.RADIO) .title("Êtes-vous satisfait des services associés (restauration universitaire, logement étudiant, bibliothèque...) ?").build());
        ...
        EQuestion q_eval_student_12     = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.RADIO) .title("Avez-vous rencontré des difficultés autres durant l'année universitaire ?").build());
        ...
        EQuestion q_eval_student_13     = qr.save(EQuestion.builder().section(s_eval_student)       .type(QuestionType.TEXT)  .title("Commentaire général").build());
            ar.save(EAnswer.builder()       .question(q_eval_student_13).build());


        EQuestion q_eval_company_1      = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.LABEL) .title("Contenu et organisation").build());
        ...
        EQuestion q_eval_company_2      = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.RADIO) .title("Apport des enseignements en rapport avec le métier").build());
        ...
        EQuestion q_eval_company_3      = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.RADIO) .title("Rythme de l'alternance").build());
        ...
        EQuestion q_eval_company_4      = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.LABEL) .title("Relation avec la Formation").build());
        EQuestion q_eval_company_5      = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.RADIO) .title("Informations par courrier, mails, téléphone").build());
        ...
        EQuestion q_eval_company_6      = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.RADIO) .title("Relation administratives").build());
        ...
        EQuestion q_eval_company_7      = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.RADIO) .title("Rencontre avec la formation").build());
        ...
        EQuestion q_eval_company_8      = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.LABEL) .title("Suivi de l’apprenti").build());
        EQuestion q_eval_company_9      = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.RADIO) .title("Communication par le livret d'alternance").build());
        ...
        EQuestion q_eval_company_10     = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.RADIO) .title("Visites du tuteur universitaire").build());
        ...
        EQuestion q_eval_company_11     = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.LABEL) .title("Évaluation globale").build());
        EQuestion q_eval_company_12     = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.RADIO) .title("Sur l'année universitaire").build());
        ...
        EQuestion q_eval_company_13     = qr.save(EQuestion.builder().section(s_eval_company)       .type(QuestionType.TEXT)  .title("Commentaires").build());
